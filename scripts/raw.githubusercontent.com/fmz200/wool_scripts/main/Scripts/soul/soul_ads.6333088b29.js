/**
 * @author fmz200
 * @function å�»é™¤Soulçš„å¹¿å‘Š&è§£é”�éƒ¨åˆ†æœ�åŠ¡
 * @date 2024-06-13 00:20:00
 * @quote ZenmoFeiShi
 */

const $ = new Env("soulå�»å¹¿å‘Š");
let req_url = $request.url;
let rsp_body = "{}";
// æ£€æŸ¥ $response æ˜¯å�¦å·²å®šä¹‰
if (typeof $response !== 'undefined' && $response !== null) {
  // å¦‚æ�œ $response å·²å®šä¹‰ä¸”ä¸�ä¸º nullï¼Œåˆ™ä½¿ç”¨ $response.body
...
try {
  ...
  if (req_url.includes("/v6/planet/config")) {
    const gamesToRemove = [
      "å¼‚ä¸–ç•Œå›�å“�", "ç‹¼äººé­…å½±", "æ¢¦æƒ³æµ·å²›ç�‹", "å¹»æƒ³æ˜Ÿç�ƒ", "çˆ†å¼¹å–µ", "æ˜Ÿç�ƒå®�éªŒå®¤", "å…´è¶£ç¾¤ç»„", "ç¾¤è�Šæ´¾å¯¹"
    ];
  ...
  console.log('è„šæœ¬è¿�è¡Œå‡ºç�°é”™è¯¯ï¼Œéƒ¨åˆ†å¹¿å‘Šæœªå�»é™¤âš ï¸�é”™è¯¯ä¿¡æ�¯ï¼š' + error.message);
}
